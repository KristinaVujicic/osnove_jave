...
//		u main funkciji, napraviti visa i master kartice i testirati funkcije
        ...
        VisaKartica visa1 = new VisaKartica(20000, "4012-1239-1221-3381", 25, 12, "Djordje Pejcic");
        VisaKartica visa2 = new VisaKartica(30000, "4012-1239-1221-3390", 27, 12, "Djordje Djordjevic");
        MasterKartica master1 = new MasterKartica(20000, "4012-1239-1221-3589", 27, 12);

        visa1.dodajSredstva(10000);
        visa1.izvrsiTransakciju(1);
        visa2.izvrsiTransakciju(10000);
        master1.naplatiOdrzavanje();
        master1.izvrsiTransakciju(10000);

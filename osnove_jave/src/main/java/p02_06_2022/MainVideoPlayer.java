...
//	U glavnom programu kreirati video plejer i izvrsiti neke akcije nad njim.
    ...
    VideoPlayer v1 = new VideoPlayer(150, 75, 45, 144);
    VideoPlayer v2 = new VideoPlayer(150, 75, 45, 144);
    ...
    QualityOptimizerControl q1 = new QualityOptimizerControl(120);
    QualityOptimizerControl q2 = new QualityOptimizerControl(10);
